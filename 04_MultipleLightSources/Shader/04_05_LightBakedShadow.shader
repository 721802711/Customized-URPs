Shader "B/04_05_LightBakedShadow"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        struct appdata
        {
            ...
            float2 staticLightmapUV : TEXCOORD1;   // 烘焙第二套UV
        };
        ...
        struct v2f
        {
            ...
            float3 positionWS : TEXCOORD2;                    //世界空间下顶点位置信息
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                col += BlinnPhongReflection(albedo.rgb, attenuatedLightColor, LightDir, NormalDir, ViewDir, smoothness);
                // ==========================================================================================================

                #ifdef LIGHTMAP_ON   
                half3 bakedGI = SAMPLE_GI(i.staticLightmapUV, i.vertexSH, NormalDir);    // 烘焙光照     
