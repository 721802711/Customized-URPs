Shader "B/04_04_MultipleLitgtsShadows"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 BlinnPhongReflection(half3 albedo, half3 lightColor, half3 lightDir, half3 normal, half3 viewDir, half4 spe, half smoothness)
            {
                ...
                half3 specular = Specular(lightColor, lightDir, normal, viewDir, spe, smoothness);
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                mylight.shadowAttenuation = MainLightRealtimeShadow(shadowCoord);
                ...
                // ==========================================================================================================
                    ...
                    {
                        Light light = GetAdditionalLight(index, i.positionWS, half4(1,1,1,1));
