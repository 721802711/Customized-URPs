Shader "B/11_03_custom"
{
    Properties
    {
        ...
        [KeywordEnum(uv,custom)] _Toggle ("Toggle Mode", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _TOGGLE_UV  _TOGGLE_CUSTOM
            ...
            #if _TOGGLE_CUSTOM
                float2 uv = i.uv.xy * i.uv2.xy + i.uv2.zw;         // X Y 是贴图的平移， Z W 是UV方向移动
            #elif _TOGGLE_UV
