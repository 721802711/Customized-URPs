Shader "B/03_02_SimpleParallaxWithOffsetLimit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half3 diffuseColor = albedo.rgb + (LightColor  * saturate(dot(normalWS, LightDir)));
                half3 halfDir = normalize(ViewDir + LightDir);
                half3 specularColor = LightColor * _SpecularColor.rgb * pow(saturate(dot(normalWS, halfDir)), _Gloss);
