Shader "B/03_04_ReliefParallaxMapping"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float2 ParallaxMapping(float2 uv, float3 viewDir_tangent, float HeightScale)
            {
                ...
                float halfLayerDepth = layerLayerHeight / 2.0;
                ...
                for(int i = 0; i < numSearches; i++)
                {
                    ...
                    float newDepth = SAMPLE_TEXTURE2D_LOD(_HeightMap, sampler_HeightMap, currentTexCoords, 1.0).r;
